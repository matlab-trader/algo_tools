function [data, errMsg] = IQC(action, parameters, varargin) %#ok
%IQC - Get historic or real-time market data from DTN IQFeed
%
% Syntax:  [data, errMsg] = IQC(action, paramName1,paramValue1, paramName2,paramValue2, ...)
%
% Inputs:
%
...
%        Fields          (String or cell-array) list of data fields to be reported by IQC (default: 16 fields)
...
%        Fields          (String or cell-array) list of data fields to be reported by IQC (default: all fields)
...
%        SmtpEmail       (String)  default='IQC.alerts@gmail.com'; sender address of email alerts. Only relevant if AlertAction='email'
