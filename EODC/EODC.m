function [data, errMsg] = EODC(action, parameters, varargin) %#ok
%EODC - Get historic or real-time market data from EODhistoricaldata.com
%
% Syntax: [data, errMsg] = EODC(action, paramName1,paramValue1, paramName2,paramValue2, ...)
%
% Inputs:
%
